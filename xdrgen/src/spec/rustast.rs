...
pub use syntax::ast::{Mod, Item, Expr, TokenTree, Ident};
pub use syntax::parse::token::str_to_ident;
pub use syntax::ext::build::AstBuilder;
pub use syntax::print::pprust::{expr_to_string, item_to_string, token_to_string};
...
pub fn parse_path(ctxt: &ExtCtxt, e: &str) -> ast::Path {
    ...
    let r = p.parse_path(syntax::parse::parser::PathStyle::Mod);
    p.abort_if_errors();
    r.unwrap_or_else(|_| panic!("failed"))
}
